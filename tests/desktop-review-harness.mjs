...
export async function loadDesktopReview({ baseline = false, mutateSharedNotes = false } = {}) {
  const mocks = {
    ...
    'useHideMobileHeader': 'export default function useHideMobileHeader() {}',
    'http': 'export default { get: (...args) => globalThis.__desktopGet ? globalThis.__desktopGet(...args) : Promise.reject(new Error("No network in render tests")) };',
