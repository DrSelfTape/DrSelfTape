      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 text-center">
            ...
            <div className="relative mx-auto w-32 h-32 mb-4">
              {avatarPreview ? (
                <img
                  src={avatarPreview}
                  alt="Avatar"
                  className="w-32 h-32 rounded-full object-cover border-4 border-[#ff6b35]/20"
                />
              ) : (
                <div className="w-32 h-32 rounded-full bg-[#ff6b35] flex items-center justify-center border-4 border-[#ff6b35]/20">
              ...
              <button
                ...
                className="absolute bottom-1 right-1 w-9 h-9 bg-[#ff6b35] rounded-full flex items-center justify-center text-white shadow-md hover:bg-[#e55a2b] transition-colors"
              >
            ...
            <span className="inline-block mt-1 px-3 py-0.5 text-xs font-medium rounded-full bg-[#ff6b35]/10 text-[#ff6b35] capitalize">
              {profile?.role || 'actor'}
            </span>
        ...
        <div className="lg:col-span-2">
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#ff6b35]/50 focus:border-[#ff6b35] outline-none transition-colors"
                  />
                </div>
                <div>
            ...
            {/* Actor Info */}
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Actor Information</h3>
              <div className="space-y-4">
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#ff6b35]/50 focus:border-[#ff6b35] outline-none transition-colors resize-none"
                  />
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Reel URL</label>
                    <input
                      name="reel_url"
                      value={form.reel_url}
                      onChange={handleChange}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <div
                    ...
                    className="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center cursor-pointer hover:border-[#ff6b35] transition-colors"
                  >
                    {headshotPreview ? (
                      <img
                        src={headshotPreview}
                      ...
                      <div className="py-4">
                        ...
                        <p className="text-sm text-gray-500">Upload headshot</p>
                  ...
                  >
                    {resumeFile ? (
                      <div className="py-4">
                        ...
                        <p className="text-sm text-gray-700 font-medium truncate">{resumeFile.name}</p>
                      </div>
                    ) : profile?.actor_profile?.resume_file ? (
                      <div className="py-4">
                        <Check className="w-8 h-8 mx-auto text-green-500 mb-2" />
                        <p className="text-sm text-gray-500">Resume uploaded</p>
                        <p className="text-xs text-[#ff6b35] mt-1">Click to replace</p>
                      </div>
                    ) : (
                      <div className="py-4">
                        <Upload className="w-8 h-8 mx-auto text-gray-400 mb-2" />
            ...
            <div className="flex justify-end">
              <button
                ...
                className="px-6 py-2.5 bg-[#ff6b35] text-white font-medium rounded-lg hover:bg-[#e55a2b] transition-colors disabled:opacity-60 flex items-center gap-2"
              >
