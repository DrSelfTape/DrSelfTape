              ...
              return (
                <div
                  ...
                  className={`flex items-start gap-3 px-4 py-3 cursor-pointer border-b border-[#1E1E1E] transition-colors ${
                    isSelected
                      ? 'bg-[#D4A85F]/5 border-l-2 border-l-[#FF8280]'
                      : 'hover:bg-[#1E1E1E] border-l-2 border-l-transparent'
                  }`}
                >
                  {/* Avatar */}
                  <div className="flex-shrink-0 w-9 h-9 rounded-full bg-[#D4A85F]/10 text-[#7A5A18] flex items-center justify-center text-xs font-bold mt-0.5">
